...
const mockFileWithCBAllTagResult = require("./mocks/mockFileWithCBAllTagResult_JSMD");
/** Mock for: File with @CBStart and @CBEnd tags */
const mockFileWithCBsTag = require("./mocks/mockFileWithCBsTags");
const mockFileWithCBsTagResult = require("./mocks/mockFileWithCBsTagsResult_JSMD");
...
const mockFileWithoutTagsResult = require("./mocks/mockFileWithoutTagsResult_JSMD");
...
describe("JSMarkdown - Testing FilterFileWithTags function...", () => {
  ...
  it("File with NO tags", () => {
    ...
    expect(resultObject.NOTAGSRESULT).toEqual(mockFileWithoutTagsResult);
  });
});
